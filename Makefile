#############################################################################
# Makefile for building: _bin/strformat
# Generated by qmake (3.1) (Qt 5.15.16)
# Project:  strformat.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile strformat.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = strformat1.0.0
DISTDIR = /home/soramimi/develop/strformat/.tmp/strformat1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		strformat.pro strformat.h main.cpp \
		test.cpp
QMAKE_TARGET  = strformat
DESTDIR       = _bin/
TARGET        = _bin/strformat


first: all
####### Build rules

_bin/strformat:  $(OBJECTS)  
	@test -d _bin/ || mkdir -p _bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: strformat.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		strformat.pro
	$(QMAKE) -o Makefile strformat.pro
...
main.o: main.cpp strformat.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

test.o: test.cpp strformat.h
